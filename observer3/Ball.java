...
public abstract class Ball implements Observer {
    ...
    public double getDistance(Ball ball){
        double x = Math.abs(this.getX() - ball.getX());
        double y = Math.abs(this.getY() - ball.getY());
        double distance = Math.sqrt(x * x + y * y);
        return distance;
    }
    abstract public void update(char keychar);
    abstract public void update(Ball ball);
}
